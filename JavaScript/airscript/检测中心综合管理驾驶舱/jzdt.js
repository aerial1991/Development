...
let range = Application.Sheets("动态数据-校准").UsedRange
...
for (let i=0;i<todaylist.length;i++){
  ...
  `DELETE FROM calibration_day WHERE ID = ${id}`)
const result2 = connection.queryAll(
  'INSERT INTO calibration_day (Year, Month, Day, Number_Daily_Commissions, Completed_Quantity, In_Progress_Quantity, ID) VALUES (?,?,?,?,?,?,?)',
