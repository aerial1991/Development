...
const result2 = connection.queryAll(
  'TRUNCATE TABLE detection_customer_commission'
)
// 打印执行结果
console.log(result2)
...
const result3 = connection.queryAll(
  'INSERT INTO detection_customer_commission (ID, Entrusting_Date, Customer_Name, Original_Number, Original_Name, Samples_Number) VALUES (?,?,?,?,?,?)',
