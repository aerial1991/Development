...
for (let item of todaylist) {
  ...
  let subject = item[1]
  let html = `<p>${res.join("<br>")}<br> <a href="https://www.kdocs.cn/l/cnvUCtS7O3Xv">https://www.kdocs.cn/l/cnvUCtS7O3Xv</a></p>`
